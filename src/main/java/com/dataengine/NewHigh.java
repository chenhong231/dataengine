...
public class NewHigh {
    ...
    private static String fold= "F:\\stockdata\\一年新高\\";

    //private static String fold= "F:\\stockdata\\一阳三线\\";

    private static String oldFile = fold + "20210103.txt";

    private static String newFile = fold + "20210105.txt";
